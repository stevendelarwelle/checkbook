...
class LedgersControllerTest < ActionController::TestCase
  ...
  test "should create ledger" do
    assert_difference('Ledger.count') do
      post :create, ledger: { amount: @ledger.amount, cleared: @ledger.cleared, description: @ledger.description, user_id: @ledger.user_id }
    end
  ...
  test "should update ledger" do
    patch :update, id: @ledger, ledger: { amount: @ledger.amount, cleared: @ledger.cleared, description: @ledger.description, user_id: @ledger.user_id }
    assert_redirected_to ledger_path(assigns(:ledger))
  end
